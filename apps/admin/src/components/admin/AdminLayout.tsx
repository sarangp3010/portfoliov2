  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="p-3 border-t border-slate-800 space-y-1">
        <a href={PUBLIC_URL} target="_blank" rel="noreferrer" className="admin-nav-item flex items-center gap-2 px-3 py-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800 transition-colors text-sm cursor-pointer">
